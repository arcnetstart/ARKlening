...
export default class Editor extends Component {
    ...
    render() {
        const {loading, pageList, backupsList, auth, loginError, loginLengthErr} = this.state;
        const modal = true;
        let spinner;      
        ...
        if(!auth) {
            return <Login login={this.login} lengthErr={loginLengthErr} logErr={loginError}/>
        }
        ...
        return (  
            <>  
                ...
                <ConfirmModal 
                    ...
                    text={{
                        title: "Сохранение",
                        descr: "Вы действительно хотите сохранить изменеия?",
                        btn: "Опубликовать"
                    }}/>
